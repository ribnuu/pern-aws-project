...
import NavBarButtons from "./NavBar/navBar";
...
const Navbar = () => {
  ...
  //                 class="hover:text-[#007bff] text-[15px] text-[#007bff] block font-bold"
  //               >
  //                 Home
  //               </a>
  //             </li>
  ...
  //               xmlns="http://www.w3.org/2000/svg"
  //               width="20px"
  //               class="cursor-pointer fill-[#000] hover:fill-[#007bff] inline-block"
  //               viewBox="0 0 64 64"
  //             >
  //               <path
  ...
  //       <div class="bg-gray-100 border border-transparent focus-within:border-blue-500 focus-within:bg-transparent flex px-6 rounded-full h-10 lg:w-2/4 mt-3 mx-auto max-lg:mt-6">
  //         <svg
  //           xmlns="http://www.w3.org/2000/svg"
