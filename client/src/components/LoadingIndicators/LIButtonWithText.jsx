...
/**
 * LIButtonWithText Component
 *
 * @param {boolean} loading - If true, shows the loading spinner and text.
 * @param {string} loadingText - The text to display when loading.
 * @param {string} labelText - The text to display when not loading.
 */
const LIButtonWithText = ({
  loading,
  loadingText,
  labelText,
      ...
      >
        {loading ? (
          <>
            ...
            {loadingText || "Loading..."} {/* Display loading text */}
          </>
        ) : (
          labelText || "Submit" // Display label text when not loading
        )}
      </button>
    </>
  );
...
export default LIButtonWithText;
