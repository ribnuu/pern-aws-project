...
// // Async thunk for loading data via an API call
...
// const initialState = {
//   formData: {},
//   records: [], // List to store created records
//   results: [], // List to store loaded data
//   searchTerm: null,
//   selectedItemId: null,
//   loading: false,
//   error: null,
...
const initialState = {
  ...
  previousFormData: {}, // Stores the previous form data for comparison
  changedFields: {}, // Stores only the fields that have been changed
  records: [],
  results: [],
  searchTerm: null,
  selectedItemId: null,
...
const formSlice = createSlice({
  ...
  reducers: {
    ...
    //   state.formData[key] = value instanceof Date ? value.toISOString() : value;
    // },
    HandleChangeFormData: (state, action) => {
      const { key, value } = action.payload;
