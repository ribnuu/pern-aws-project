...
const CarParkServicesVehicleNumber = () => {
  ...
  const [vehicle_number, setVehicle_number] = useState(params.vehicleNumber);

  useEffect(() => {
    setVehicle_number(params.vehicleNumber);
    ...
    <section className="mx-12 lg:my-12 my-8">
      ...
      <div>
        ...
        <div>
          {nawalokaHospitalData && (
            <div className="">
              <div className="lg:text-2xl text-md text-center my-8 rounded-lg bg-banner-header uppercase">
                NAWALOKA HOSPITAL
              </div>
              <div className="grid grid-cols-2 gap-2">
                      ...
                      <div className="grid grid-cols-3 gap-2">
                        <div className="col-span-1">
                          <div className="rounded-lg my-auto  ">
                            <img
                              src={`http://localhost:4000${data.vehicle_image_path}`}
                              className="lg:w-64 lg:h-24 border-2 border-black w-32 h-32 object-cover rounded-lg"
                            />
                          </div>
                        </div>
                        <div className="col-span-2 my-auto">
...
export default CarParkServicesVehicleNumber;
