...
const MainHome = () => {
  ...
  const localStorageData = localStorage.getItem("user_id");

  // Debugging: Log the value of localStorageData
...
const PageWithLocalStorage = () => {
  // Component to render when local storage data exists
  return <NullHome />;
};
        ...
        <div className="max-w-6xl mx-auto px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="bg-gray-700 p-8 rounded-lg shadow-lg hover:bg-gray-600 transition-all duration-300 ease-in-out">
              ...
              <p className="text-gray-300">
                Equip your team with the knowledge and skills to defend against
                cyber threats.
              </p>
            </div>
            {/* Feature Card 4 */}
