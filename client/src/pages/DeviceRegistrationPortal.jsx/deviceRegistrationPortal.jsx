  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const createDeviceResponse = await axios.post(
        `http://${server_port}:4000/api/device-registration/createDeviceRegistration`,
        {
          formData,
        }
      );
      ...
      <div className=" bg-white p-4 rounded-md  border border-black">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="relative z-0 w-full mb-6 group">
            <input
              type="text"
              name="device_imei_number"
              id="device_imei_number"
              className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
              placeholder=" "
          ...
          <div className="relative z-0 w-full mb-6 group">
            <input
              ...
              className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
              placeholder=" "
              value={formData.device_mac_address}
              onChange={handleChange}
              required
            />
            <label
              htmlFor="device_mac_address"
              className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
              value=""
            >
              Device MAC Address
          ...
          <div className="relative z-0 w-full mb-6 group">
            <input
              ...
              id="device_registered_datetime"
              className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
              placeholder=" "
              value={formData.device_registered_datetime}
              onChange={handleChange}
              required
            />
            <label
              htmlFor="device_registered_datetime"
              className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
              value=""
            >
              Device Registered Datetime
            </label>
          </div>
