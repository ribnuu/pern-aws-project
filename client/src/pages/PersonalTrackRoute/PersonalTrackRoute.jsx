  ...
  return (
    ...
    <section className='mx-12 my-12'>
      <form>
        ...
        <div>
            Helps us draw a live or past map of a person travelling or moving around anywhere in the world.<br /><br />
...
export default PersonalTrackRoute