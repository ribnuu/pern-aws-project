...
const ReportHouseHoldersListTabView = ({ formData }) => {
    ...
    <div className="w-full">
      <div className="relative right-0">
        ...
        <div className="mt-4">
          ...
          {selectedTab === "chiefOccupantInformation" && (
            <div>
              <HouseHoldersChiefOccupantInfoForm />
            </div>
          )}
          {selectedTab === "familyMembersInformation" && (
            <div>
              <HouseHoldersFamilyMembersInfoForm />
            </div>
          )}
          {selectedTab === "otherResidentsInformation" && (
            <div>
              <HouseHoldersOtherResidentsInfoForm />
            </div>
          )}
        </div>
      </div>
...
export default ReportHouseHoldersListTabView;
