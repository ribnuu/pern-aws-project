...
import {
  getAllExpensesSubCategoriesByCategoryCodeApi,
  updateMultipleExpensesSubCategoriesApi,
} from "../../../apis/POSExpensesCategorySubCategoryApiService";

const ExpensesCategorySubCategoryDisplay = () => {
  ...
  const handleSave = async () => {
    ...
    if (itemsToUpdate.length > 0) {
      await updateMultipleExpensesSubCategoriesApi(itemsToUpdate);
    }
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        if (selectedCategory) {
          const response = await getAllExpensesSubCategoriesByCategoryCodeApi(
            selectedCategory
          );
...
export default ExpensesCategorySubCategoryDisplay;
