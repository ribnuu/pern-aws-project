...
import ReturnStockNotMaintainedAddedToBillItems from "./ReturnStockNotMaintainedAddedToBillItems";

const ReturnPOSBillingScreen = () => {
                  ...
                  {isLoadItemsFromStockItemHeader && (
                    <div className="flex flex-col flex-grow">
                      <div className="overflow-y-auto flex-grow max-h-[500px] [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']">
                        <ReturnStockNotMaintainedAddedToBillItems />
                      </div>
                    </div>
                  )}
                </div>
...
export default ReturnPOSBillingScreen;
