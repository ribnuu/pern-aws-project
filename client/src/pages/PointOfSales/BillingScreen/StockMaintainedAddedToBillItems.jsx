...
const StockMaintainedAddedToBillItems = () => {
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <input
                      ...
                      type="number"
                      value={item.quantity}
                      className="bg-gray-50 w-28 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block px-2.5 py-1 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
...
export default StockMaintainedAddedToBillItems;
