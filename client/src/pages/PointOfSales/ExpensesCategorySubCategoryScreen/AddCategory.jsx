...
import { createPosExpensesMainCategoryApi } from "../../../apis/POSExpensesCategorySubCategoryApiService";
...
const AddCategory = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setIsLoading(true);
    try {
      const response = await createPosExpensesMainCategoryApi(formData);
